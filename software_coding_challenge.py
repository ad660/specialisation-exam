...
class Planet:
    def __init__(self, name, distance, planet_type):
        self.name = name
    ...
    def get_distance_to_earth(self):
        ...
        return {'distance to earth': abs(self.distance_from_sun - earth_distance_from_sun)}


our_planet = Planet('Earth', 148000000, 'Star')
print(our_planet.get_distance_to_earth())
...
class Jupiter(Planet):
    def __init__(self, name, distance_from_sun, planet_type, num_of_moons, orbital_period):
        super().__init__(name, distance_from_sun, planet_type)
    ...
    @staticmethod
    def happy_new_year():
        print("A year on Jupiter lasts 4,383 Earth days.")

# instance
jupiter = Jupiter("Jupiter", 779000000, "Gas Giant", 80, 4383)
...
print(f"Number of Moons: {jupiter.num_of_moons}")
print(f"Orbital Period: {jupiter.orbital_period} days")
